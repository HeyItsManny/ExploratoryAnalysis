...
# The code below is for plot4
# first set up the plot environment 
par(mfrow = c(2,2))

# chart 1
plot(dataf$datewtime,dataf$Global_active_power, type="l", xlab="", ylab="Global Active Power")

# chart 2
plot(dataf$datewtime,dataf$Voltage, type="l", xlab="datetime", ylab="Voltage")

# chart 3
plot(dataf$datewtime, dataf$Sub_metering_1, type="l", ylab="Energy sub metering", xlab="", col="black")
lines(dataf$datewtime, dataf$Sub_metering_2, col="red")
lines(dataf$datewtime, dataf$Sub_metering_3, col="blue")

legend("topright", lty=c(1,1,1), y.intersp=0.09, cex=0.8, bty = "n", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))

# chart 4
plot(dataf$datewtime,dataf$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
